...
interface ProcessedEventJpaRepository extends JpaRepository<ProcessedEventEntity, ProcessedEventEntity.Key> {
    ...
    @Query(
            value =
                    """
                    INSERT INTO application.processed_event (event_id, consumer, processed_at)
