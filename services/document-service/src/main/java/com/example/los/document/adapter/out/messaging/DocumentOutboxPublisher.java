package com.example.los.document.adapter.out.messaging;
...
import com.example.los.document.adapter.out.persistence.DocumentOutboxRelayGateway;
import com.example.los.document.adapter.out.persistence.DocumentOutboxRelayGateway.PendingEvent;
...
public class DocumentOutboxPublisher {
    ...
    private final DocumentOutboxRelayGateway gateway;
    ...
    public DocumentOutboxPublisher(
            DocumentOutboxRelayGateway gateway,
