...
@IdClass(AuditProcessedEventEntity.Key.class)
class AuditProcessedEventEntity {
    ...
    protected AuditProcessedEventEntity() {}

    AuditProcessedEventEntity(String eventId, String consumer, Instant processedAt) {
        this.eventId = eventId;
        this.consumer = consumer;
    ...
    public String toString() {
        return "AuditProcessedEventEntity[eventId=" + eventId + ", consumer=" + consumer + "]";
    }
}
