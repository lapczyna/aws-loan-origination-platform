 ...
 */
@Component
class JpaWorkflowProcessedEventStore implements ProcessedEventStore {

    private final WorkflowProcessedEventJpaRepository processed;
    private final Clock clock;

    JpaWorkflowProcessedEventStore(WorkflowProcessedEventJpaRepository processed, Clock clock) {
