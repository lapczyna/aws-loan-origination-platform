package com.example.los.workflow.adapter.out.messaging;
...
import com.example.los.workflow.adapter.out.persistence.WorkflowOutboxRelayGateway;
import com.example.los.workflow.adapter.out.persistence.WorkflowOutboxRelayGateway.PendingEvent;
...
public class WorkflowOutboxPublisher {
    ...
    private final WorkflowOutboxRelayGateway gateway;
    ...
    public WorkflowOutboxPublisher(
            WorkflowOutboxRelayGateway gateway,
