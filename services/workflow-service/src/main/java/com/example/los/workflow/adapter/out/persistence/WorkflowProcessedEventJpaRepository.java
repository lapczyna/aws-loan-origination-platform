...
interface WorkflowProcessedEventJpaRepository extends JpaRepository<WorkflowProcessedEventEntity, WorkflowProcessedEventEntity.Key> {
    ...
    @Query(
            value =
                    """
                    INSERT INTO workflow.processed_event (event_id, consumer, processed_at)
