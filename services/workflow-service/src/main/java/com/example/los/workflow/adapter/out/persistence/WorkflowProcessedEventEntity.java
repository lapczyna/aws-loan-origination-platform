 ...
 */
@Entity
@Table(name = "processed_event", schema = "workflow")
@IdClass(WorkflowProcessedEventEntity.Key.class)
class WorkflowProcessedEventEntity {
    ...
    protected WorkflowProcessedEventEntity() {}

    WorkflowProcessedEventEntity(String eventId, String consumer, Instant processedAt) {
        this.eventId = eventId;
        this.consumer = consumer;
    ...
    public String toString() {
        return "WorkflowProcessedEventEntity[eventId=" + eventId + ", consumer=" + consumer + "]";
    }
}
